...
oCMenu.onlineUrl="http://www.net4domains.com/js/" //Value: "path_to_menu_file_online/"
...
oCMenu.usebar="menu" //If you want to use a background-bar for the top items set this on - Value: 1 || 0
oCMenu.barcolor="#aabbcc" //The color of the background bar - Value: "color"
oCMenu.barwidth="770" //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.fromtop=109 //This is the top position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.level[0].bgcoloroff="#663300" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[0].bgcoloron="#ff6666" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
oCMenu.level[0].style="padding:2px; font-family:verdana,tahoma,arial,helvetica; font-size:12px;font-weight:bold;" //The style for all level[0] (top) items. - Value: "style_settings"
oCMenu.level[0].border=0 //The border size for all level[0] (top) items. - Value: px
oCMenu.level[0].bordercolor="#0077B0" //The border color for all level[0] (top) items. - Value: "color"
...
oCMenu.level[0].clippx=5 //If you have clip spesified you can set how many pixels it will clip each timer in here to control the speed of the animation. - Value: px
...
oCMenu.level[1].bgcoloroff="#b7b7b7" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[1].bgcoloron="#b7b7b7" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
oCMenu.level[1].bordercolor="#0077B0" //The border color for all level[0] (top) items. - Value: "color"
