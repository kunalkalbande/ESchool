					...
					<td align="center"><b>DAILY FEES RECIEPT REPORT</b>
						<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="80%" borderColorLight="#663300"
							...
							<TR>
								...
								<asp:button id="Button1" BorderColor="Black" BorderStyle="Groove"  runat="server" Width="85px" Height=21 CssClass="FormButtonStyle" Text="Print"  ></asp:button>&nbsp;
								<asp:button id="btnExcel" BorderColor="Black" BorderStyle="Groove" runat="server" Width="85px" Height=21 CssClass="FormButtonStyle" Text="Excel"  ></asp:button>&nbsp;&nbsp;</TD>
							</TR>
							<%
							if(flage==1)
							{
