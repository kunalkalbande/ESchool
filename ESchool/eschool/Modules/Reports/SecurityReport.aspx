						...
						<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="80%" borderColorLight="#663300"
							...
							<TR>
								<td align="center">Class&nbsp;&nbsp;<asp:dropdownlist id="DropClass" CssClass="ComboBox" Width="80" Runat="server"></asp:dropdownlist>&nbsp;&nbsp; 
									...
									<asp:button id="Button1" BorderColor="Black" BorderStyle="Groove" BackColor="#E0E0E0" runat="server"
										Width="85px" CssClass="FormButtonStyle" Text="Print" Height="21" BorderWidth="2px" Font-Size="X-Small"></asp:button>&nbsp;&nbsp;
									<asp:button id="Exel" BorderColor="Black" BorderStyle="Groove" BackColor="#E0E0E0" runat="server"
										Width="85px" CssClass="FormButtonStyle" Text="Exel" Height="21" BorderWidth="2px" Font-Size="X-Small"></asp:button>
								</td>
							</TR>
